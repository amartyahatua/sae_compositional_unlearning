...
class Config:
    ...
    D_MODEL       = 768              # 768 small, 1024 medium
    DICT_SIZES    = [4096, 8192, 16384, 32768, 65536]
    LAYERS        = list(range(12))  # 0-11 small, 0-23 medium
    SAE_BASE_PATH = '../models'
    RESULTS_PATH  = '../results/sae_training_simple/recovered_metrics.csv'
    MAX_LENGTH    = 512
    BATCH_SIZE    = 8
    MAX_BATCHES   = 50               # enough for stable MSE estimate
