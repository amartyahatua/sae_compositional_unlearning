...
def calibrate_all_configs():
    ...
    print("EleutherAI/pythia-6.9b")
    model, tokenizer = get_gptmodel('EleutherAI/pythia-6.9b')
    ...
    print(f"  - Summary stats: {OUTPUT_DIR}/summary_statistics_13_Mar.csv")
