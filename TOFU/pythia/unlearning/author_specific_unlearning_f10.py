...
def unlearn_author(author_name, author_indices, output_dir, device='cuda'):
    ...
    base_model, tokenizer = get_gptmodel('gpt2-medium')
...
def main():
    ...
    baseline_model_path = '../TOFU/baseline/models/gpt2_tofu_lora/checkpoint-1190'
